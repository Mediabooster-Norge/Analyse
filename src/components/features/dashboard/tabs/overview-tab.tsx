        ...
        <div className="p-2 max-[400px]:p-2 min-[401px]:p-3 sm:p-6 space-y-3 max-[400px]:space-y-3 sm:space-y-4">
          ...
          <div data-metric="ytelse">
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              {retryPageSpeed && !loadingPageSpeed && (
                <button
                  onClick={retryPageSpeed}
                  className="inline-flex items-center gap-1 text-[10px] sm:text-xs px-2 py-1 rounded-lg text-neutral-500 hover:text-neutral-700 hover:bg-neutral-100 transition-colors shrink-0 ml-2"
                >
                  ...
                  loadingPageSpeed
                    ...
                    ? result.pageSpeedResults.performance >= 90
                      ...
                      : result.pageSpeedResults.performance >= 50
                        ? 'Trenger forbedring'
                        : 'Dårlig ytelse'
                    : retryPageSpeed ? 'Klikk «Mål på nytt» for å teste hastighet' : 'Ikke målt'
                }
                recommendation={
